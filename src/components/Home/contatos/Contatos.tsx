  ...
  return (
    <div id="contatos" className="xl:h-screen bg-black flex items-center pb-10 sm:pb-20 md:pb-10 xl:pb-0">
      <div className="md:max-w-2xl lg:max-w-3xl md:mx-auto w-full">
        ...
        <form onSubmit={sendEmail} className="w-5/6 md:w-full mx-auto md:mx-0 md:grid md:grid-cols-5 md:gap-x-5 md:gap-y-6 md:mt-8 space-y-5 md:space-y-0">
          ...
          <div className="md:col-span-2 space-y-2">
            ...
            <input type="tel" id="telefone" name="telefone" pattern="[0-9]{11}" className="mt-1 p-2 block w-full border-gray-300 rounded-2xl shadow-sm focus:ring-primary-500 focus:border-primary-500 text-black bg-white placeholder:text-primary-300 text-base" placeholder="Exemplo: 11 88888-8888" />
          </div>
